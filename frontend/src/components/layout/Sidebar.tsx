...
const PHASES = [
  ...
  { path: '/setup',       number: '1',    label: 'Setup'       },
  { path: '/import',      number: '2',    label: 'Import'      },
  { path: '/screening',   number: '3',    label: 'Screening'   },
  { path: '/eligibility', number: '4',    label: 'Eligibility' },
  { path: '/snowballing', number: '5',    label: 'Snowballing' },
  { path: '/quality',     number: '6',    label: 'Quality'     },
  { path: '/extraction',  number: '7',    label: 'Extraction'  },
  { path: '/results',     number: '8',    label: 'Results'     },
]
